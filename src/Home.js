    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.avatarWrap}>
          <Image style={styles.avatar} source={{uri: this.props.screenProps.profile.picture}} />
        </View>
        <View style={styles.margin} />
        <TouchableOpacity style={styles.buttonWrap} onPress={this.props.screenProps.logout}>
